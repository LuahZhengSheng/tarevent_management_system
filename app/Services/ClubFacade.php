...
class ClubFacade
{
     ...
     * @throws \Exception If user is already a member or has a pending request
     */
     ...
     * @throws \Exception If no pending request exists or user is already a member
     */
     ...
     * @throws \Exception If no pending request exists
     */
