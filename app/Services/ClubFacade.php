...
class ClubFacade
{
     ...
     * 
     * @param array $data Club data (name, description, email, phone, logo, club_user_id, etc.)
    ...
    public function createClub(array $data, User $creator): Club
    {
        ...
        return DB::transaction(function () use ($data, $creator) {
            ...
            // club_user_id is optional - accept from $data if provided, otherwise leave null
            // No error thrown if club_user_id is missing
