...
<div class="admin-user-create-page">
    ...
    <div class="admin-page-header mb-4">
        ...
        <p class="admin-page-subtitle">Create a new student or club organizer account</p>
    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            >
                                ...
                                <option value="club" {{ old('role') === 'club' ? 'selected' : '' }}>Club Organizer</option>
                            </select>
                            @error('role')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <p style="margin: 0; font-size: 0.8125rem; color: var(--text-secondary);">
                                    A random password will be generated automatically and sent to the user's email address upon account creation.
                                </p>
                            </div>
                        </div>
                    </div>
